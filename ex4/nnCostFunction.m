...
for t=1:m
    ...
    %Step 3
    z2= [1;z2];
    delta_2= Theta2'* delta_3 .* sigmoidGradient(z2); % ((26x10)*(10x1))=(26x1)
    
    % Step 4
    delta_2 = delta_2(2:end); % skipping sigma2(0) (25*1)
    
    Theta2_grad= Theta2_grad + delta_3 * a2'; % (10x1)*(1x26)= 10x26
    Theta1_grad= Theta1_grad + delta_2 * a1'; % (25x1)*(1x401)= 25x401
